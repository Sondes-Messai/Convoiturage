...
@Getter
@ToString
public class ContactUsFormNotNullException extends RuntimeException implements ExceptionWithErrorResponse {
    ...
    public ContactUsFormNotNullException(String message) {
